...
/* In a future release of Bison, this section will be replaced
   by #include "parser.h".  */
#ifndef YY_WORK_PARSER_H
# define YY_WORK_PARSER_H
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
{
       0,    95,    95,    99,   100,   102,   103,   105,   106,   108,
     109,   111,   112,   114,   115,   117,   118,   120,   121,   123,
     125,   126,   127,   128,   129,   130,   131,   132,   134,   136,
     138,   140,   142,   143,   145,   147,   149,   151,   152,   153,
     154,   155,   156,   157,   158,   159,   160,   161,   162,   163,
     164,   165,   167,   169,   171,   176,   177,   179
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      17,     0,    11,     0,     0,    12,     0,     0,    36,     0,
       0,     0,    14,    19,    26,    20,    21,    27,    22,    23,
      24,    25,     0,    54,    57,     0,     0,    31,    55,    50,
...
#line 151 "src/parser.y"
    { (yyval) = CN2D(expression_n, "+",  (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)])); }
    break;
...
#line 157 "src/parser.y"
    { (yyval) = CN1D(expression_n, "-", (yyvsp[(2) - (2)])); }
    break;
...
#line 165 "src/parser.y"
    { (yyval) = CN2D(expression_n, "F", (yyvsp[(1) - (4)]), (yyvsp[(3) - (4)])); }
    break;
