...
VariableList: Variable { $$ = CN1N(expression_list_n, $1); } 
	...
	;
DeclarationList: DeclarationList Declaration {fprintf ( stderr, "DECLARE"); $$ = CN2N(declaration_list_n, $1, $2);}
			| {$$ = NULL;}
	;		
...
ParameterList: VariableList { $$ = CN1N(parameter_list_n, $1); }
			| {$$ = NULL;}
	;
Function: FUNC Variable '(' ParameterList ')' Statement { fprintf ( stderr, "Function"); $$ = CN3N(function_n, $2, $4, $6);}
	;
...
AssignmentStatement: Variable { $$ = CN1N(assignment_statement_n, $1); }
	;
Variable: Expression { $$ = CN1N(variable_n, $1); }
	;
