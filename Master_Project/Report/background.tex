...
\begin{itemize}
    \item CPUs are bad at exploiting parallelism.
    \item FPGA/ASIC can be faster, and generally uses less power. 
    \item Low power usage have become increasingly important, due to data centers and mobile computers. 
    \item FPGA/ASIC vs GPU. Generally, slower but more power efficient (application specific though). 
