...
The Zedboard is a development board for the \textit{Xilinx Zynq®-7020 All Programmable System-on-Chip (SoC)}. The Zynq®-7020 consists of a dual-core \textit{ARM Cortex-A9 MPCore based Processing System (PS)} that is tightly coupled to Xilinx \textit{programmable logic} (PL), that contains a Artix-7 FPGA. The PS includes on-chip memory, external memory interfaces, and a number of I/O peripherals.
...
\begin{figure}[h!]
  ...
  \caption{Zyng-7000 system architecture.}
