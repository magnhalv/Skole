...
configured for a dataset gives us more time to explore the hardware part, instead of the topology part. 

For a pure software implementation of the LeNet-5 we used XXXXX's framework for neural networks, which is available at
XXXXX. For a detailed introduction of the LeNet-5 network, please refer to the orignal paper \cite{XXXXX}. 
